...
[**findUserById**](UserApi.md#findUserById) | **GET** /users/{userId} | 
[**findUserByPlantRecordId**](UserApi.md#findUserByPlantRecordId) | **GET** /users/plant_records/{plantRecordId} | 
...
let body:.UserApiFindUserByIdRequest = {
  // string | ユーザーID
  userId: "1",
};

apiInstance.findUserById(body).then((data:any) => {
  console.log('API called successfully. Returned data: ' + data);
}).catch((error:any) => console.error(error));
```
...
# **findUserByPlantRecordId**
> User findUserByPlantRecordId()
...
let body:.UserApiFindUserByPlantRecordIdRequest = {
  // string | 生育記録ID
  plantRecordId: "1",
};

apiInstance.findUserByPlantRecordId(body).then((data:any) => {
  console.log('API called successfully. Returned data: ' + data);
}).catch((error:any) => console.error(error));
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **plantRecordId** | [**string**] | 生育記録ID | defaults to undefined
