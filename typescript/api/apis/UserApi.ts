...
export class UserApiRequestFactory extends BaseAPIRequestFactory {
    ...
    public async deleteUser(userId: string, _options?: Configuration): Promise<RequestContext> {
        ...
        if (userId === null || userId === undefined) {
            throw new RequiredError("UserApi", "deleteUser", "userId");
        }
     ...
     */
    public async getUsersOrGetUserByName(username?: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
     ...
     * @param coverImage 
     */
    public async updateUser(userId: string, formData?: UpdateUserFormData, profileImage?: HttpFile, coverImage?: HttpFile, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
        ...
        if (profileImage !== undefined) {
             ...
             if (localVarFormParams instanceof FormData) {
                 localVarFormParams.append('profileImage', profileImage, profileImage.name);
             }
        }
        if (coverImage !== undefined) {
             // TODO: replace .append with .set
             if (localVarFormParams instanceof FormData) {
                 localVarFormParams.append('coverImage', coverImage, coverImage.name);
             }
        }
...
export class UserApiResponseProcessor {
     ...
     */
     public async deleteUser(response: ResponseContext): Promise<User > {
        ...
        if (isCodeInRange("401", response.httpStatusCode)) {
            throw new ApiException<undefined>(response.httpStatusCode, "401(Unauthorized)", undefined, response.headers);
        }
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to getUsersOrGetUserByName
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getUsersOrGetUserByName(response: ResponseContext): Promise<Array<User> > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
